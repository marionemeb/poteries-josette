...
- **Titres de section** ("hero") : très grands (96px desktop, 40–50px mobile), police `Courgette`, blancs, avec une bordure blanche en haut et en bas (accueil) ou juste en bas (galerie articles).
